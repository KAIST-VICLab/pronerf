...
def render_rays(ray_batch, or_ray_batch,
    ...
    with torch.no_grad():
        ...
        # rays_valid_id = kwargs['rays_img_id'].transpose(0, 1)[None,:,None,None,None].repeat(1, 1, num_pts,3,1,1) 
        # # filter
        ...
        mean_warps_flat = (mean_warps_flat.view(num_pts, 3, warp_H*warp_W).permute(2,0,1)).reshape(-1, 3*num_pts) # N rays, 3*num_pts
