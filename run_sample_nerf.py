...
def create_nerf(args):
    ...
    model_mmray = MinMaxRayS_Net(D=args.mmnetdepth, W=args.mmnetwidth,
                                 ...
                                 output_ch=2*args.N_samples if args.a_mmrgb == 0 else 3+2*args.N_samples,
...
def compute_query_points_from_rays(
  ...
  """
    ...
    mm_rgb = None
    if min_max_rays.shape[1] > num_samples*2:
        mm_rgb = min_max_rays[:, num_samples*2::]
...
def train():
    ...
    for i in trange(start, N_iters):
        ...
        if args.a_mmdisp > 0 and i > 1000:
            mm_disp_loss = args.a_mmdisp * img2mse(extras['depth_map'].detach(), dst)
