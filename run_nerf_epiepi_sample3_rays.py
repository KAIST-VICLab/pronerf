...
def render_rays(ray_batch, or_ray_batch, coords, target_pose, ref_poses, ref_rgbs, Hfull, Wfull, K, ref_K,
    ...
    pts, epi_z_vals = compute_query_points_from_rays(or_rays_o, or_rays_d, or_near, or_far, N_point_ray_enc, randomize)
    ...
    if rp_k_ref > 0:
        with torch.no_grad():
            ...
            depths = epi_z_vals.view(1, 1, 1, N_point_ray_enc).repeat(rp_k_ref, 1, N_rays, 1) # k_ref, H, W, N_point_ray_enc
