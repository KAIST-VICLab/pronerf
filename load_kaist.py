...
def load_kaist_data(basedir, factor=8, recenter=True, bd_factor=.75, spherify=False, path_zflat=False):
...
def load_kaist_data_infer(basedir, factor=8, recenter=True, bd_factor=.75, spherify=False, path_zflat=False, num_neighbor=None, llffhold=8):
