...
def render_rays(ray_batch, or_ray_batch,
    ...
    with torch.no_grad():
        ...
        ref_nos = rel_cam_idx[:, 0:num_neighbor][0]
        ...
        # warps = inverse_warp.trt_warp(ref_rgb, depths, ro1, rd1, ref_pose, ref_K)
        breakpoint()
    ...
    print('render time:', t1.elapsed_time(t2))  
