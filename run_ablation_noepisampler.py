...
def config_parser():
    ...
    parser.add_argument("--basedir", type=str, default='./logs_ablation/',
...
def render_rays(ray_batch, or_ray_batch,
    ...
    # net_input = plucker_embed.view(N_rays, -1)
    ...
    refine_depth_values = depth_values
    ...
    ret = {'rgb_map0': mm_rgb, 'rgb_map1': rgb_map, 'depth_map': depth_map, 'mm_rgb': mm_rgb, 'depth_map0': refine_depth_values.mean(dim=-1)}
    if train_sampler:
...
def train():
    ...
    for i in trange(start, N_iters):
        ...
        if i % 2 != 0:
            ...
            loss = img_loss + rgb0_loss + sigma_loss + aux_rgb_loss
