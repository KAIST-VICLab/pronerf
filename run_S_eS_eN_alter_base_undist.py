...
from load_llff_undist_nex import load_llff_data
...
def train():
    ...
    if args.dataset_type == 'llff':
        images, poses, bds, render_poses, i_test, intrinsic = load_llff_data(args.datadir, factor = None, split_train_val = 8, render_style = 'llff')

        H, W, fx, fy, cx, cy = intrinsic.squeeze()
        hwf = [H, W, fx]
