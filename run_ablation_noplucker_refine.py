...
def create_nerf(args):
    ...
    model_refine = MinMaxRay_Net(D=args.mmnetdepth, W=args.mmnetwidth,
                                ...
                                6 + 3 * (0+args.N_samples) + 3 * args.num_neighbor * args.N_samples,
...
def render_rays(ray_batch, or_ray_batch,
    ...
    plucker_embed = torch.cat((rays_o[:,None], rays_d[:,None], epi_pts), 1).view(-1, 6 + num_pts * 3).view(N_rays, -1)
