...
def create_nerf(args):
    ...
    pretrained_nerf_ckpt = torch.load('logs_minmax/fern_baseline/300000.tar')
    model.load_state_dict(pretrained_nerf_ckpt['network_fn_state_dict'])
...
def render_rays(ray_batch, coords, target_pose, ref_poses, ref_rgbs, H, W, K, k_ref,
    ...
    # if kwargs['iteration'] < 500000:
    if kwargs['iteration'] < 10000:
    ...
    ret = {'rgb_map0': rgb0, 'rgb_map1': rgb_map, 'depth_map':depth_map, 'depth_map0': depth0, 'mm_rgb': mm_rgb}
...
def train():
    ...
    for i in trange(start, N_iters):
        ...
        loss = img_loss + perc_loss + rgb0_loss + disp_loss + mmrgb_loss 
