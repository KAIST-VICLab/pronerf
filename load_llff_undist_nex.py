...
def load_llff_data(basedir, factor=8, recenter=True, bd_factor=.75, spherify=False, path_zflat=False, split_train_val=0, render_style='llff'):

    # poses, bds, imgs = _load_data(basedir, factor=factor) # factor=8 downsamples original imgs by 8x
    # factor=8 downsamples original imgs by 8x
    poses, bds, imgs, intrinsic = _load_data(basedir, factor=factor, load_imgs=True, height=756)
...
#   if split_train_val == 0:
    ...
    return images, poses, bds, render_poses, i_test, intrinsic
